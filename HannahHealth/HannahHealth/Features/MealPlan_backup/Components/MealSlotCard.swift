...
struct MealSlotCard: View {
    ...
    init(day: DayOfWeek,
        ...
        self._isMealNameFocused = isMealNameFocused
        self._isMealTypeFocused = isMealTypeFocused
